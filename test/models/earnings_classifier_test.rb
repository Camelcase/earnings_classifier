...
class EarningsClassifierTest < ActiveSupport::TestCase
  setup do
    ...
    # log hours on saturday
    HoursRule.create!(
      code: "SATURDAY_HOURS",
      hours_rule_config: HoursRuleConfig.new(rank: 2),
      earning_tests: [
        MaximumHoursTest.new(maximum_hours_test_config: MaximumHoursTestConfig.new(period: "hours_of_day", threshold: 6))
      ]
    )
    ...
    HoursRule.create!(
      ...
      hours_rule_config: HoursRuleConfig.new(rank: 2),
      earning_tests: [
        MaximumHoursTest.new(maximum_hours_test_config: MaximumHoursTestConfig.new(period: "hours_of_day", threshold: 0))
      ]
    )
  ...
  test "saturday" do
    ...
    timesheet.shifts.create!(start: date4.in(9.hours), finish: date4.in(18.hours)) # 9am -> 6pm
    timesheet.shifts.create!(start: date5.in(9.hours), finish: date5.in(18.hours)) # 9am -> 6pm
    timesheet.shifts.create!(start: date6.in(9.hours), finish: date6.in(12.hours)) # 9am -> 12am
  ...
  test "sunday" do
    ...
    date4 = Time.zone.today.prev_occurring(:monday).advance(days: 3)
    date5 = Time.zone.today.prev_occurring(:monday).advance(days: 4)
    date6 = Time.zone.today.prev_occurring(:monday).advance(days: 6)
    ...
    timesheet.shifts.create!(start: date4.in(9.hours), finish: date4.in(18.hours)) # 9am -> 6pm
    timesheet.shifts.create!(start: date5.in(9.hours), finish: date5.in(18.hours)) # 9am -> 6pm
    timesheet.shifts.create!(start: date6.in(9.hours), finish: date6.in(12.hours)) # sun, 9am -> 12am
  ...
  test "friday overnight into saturday" do
    ...
    timesheet.shifts.create!(start: date3.in(9.hours), finish: date3.in(18.hours)) # 9am -> 6pm
    timesheet.shifts.create!(start: date4.in(9.hours), finish: date4.in(18.hours)) # 9am -> 6pm
    timesheet.shifts.create!(start: date5.in(18.hours), finish: date5.in(26.hours)) # 6pm -> next day, 2am
  ...
  test "saturday overnight into sunday" do
    ...
    date3 = Time.zone.today.prev_occurring(:monday).advance(days: 2)
    date4 = Time.zone.today.prev_occurring(:monday).advance(days: 3)
    date5 = Time.zone.today.prev_occurring(:monday).advance(days: 5)
    ...
    timesheet.shifts.create!(start: date3.in(9.hours), finish: date3.in(18.hours)) # 9am -> 6pm
    timesheet.shifts.create!(start: date4.in(9.hours), finish: date4.in(18.hours)) # 9am -> 6pm
    timesheet.shifts.create!(start: date5.in(18.hours), finish: date5.in(26.hours)) # sat 6pm -> next day, 2am
